...
public class AccountAppIFUnder {
	...
	public static void main(String[] args) {
		...
		double dividend1 = (income)*1; // Dividend 5할 계산 변수
		double dividend2 = (income)*0; // Dividend 3할 계산 변수
		double dividend3 = (income)*0; // Dividend 2할 계산 변수
